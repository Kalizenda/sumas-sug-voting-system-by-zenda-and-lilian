...
const NewDashboard = () => {
    ...
    const upcomingElections = [
        { id: '1', name: 'Student Union Presidential Election', date: '2026-03-15' },
        { id: '2', name: 'Faculty Senate Election', date: '2026-04-10' },
        { id: '3', name: 'Departmental Representatives Election', date: '2026-05-05' },
        { id: '4', name: 'Student Council Election', date: '2026-06-01' },
    ];
    ...
    useEffect(() => {
        ...
        socket.on('voteUpdate', () => {
            console.log('Vote update received, refreshing dashboard');
            fetchDashboardData();
        });

        socket.on('currentResults', () => {
            console.log('Results updated, refreshing dashboard');
            fetchDashboardData();
        });
