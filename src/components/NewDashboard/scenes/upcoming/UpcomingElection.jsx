...
const UpcomingElection = () => {
    ...
    const staticElections = [
        { id: '1', name: 'Student Union Presidential Election', date: '2026-03-15', status: 'upcoming' },
        { id: '2', name: 'Faculty Senate Election', date: '2026-04-10', status: 'upcoming' },
        { id: '3', name: 'Departmental Representatives Election', date: '2026-05-05', status: 'current' },
        { id: '4', name: 'Student Council Election', date: '2026-06-01', status: 'upcoming' },
    ];
